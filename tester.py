...
# Script to test a trained neural net on a wav file
...
if __name__ == '__main__':
    ...
    net = NetworkReader.readFrom(os.path.basename(dirname) + 'classifbignet')
    ...
    for t in tracks:
        ...
        for i in range(numData):
            indicatorVector = numpy.array(60) #60 possible output notes
            indicatorVector = net.activate(features[i])
